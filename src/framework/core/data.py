...
def needs_session(fn):
    """Dichiara che la callable riceve la sessione runtime come primo argomento."""
...
def _first_parameter_is_session(fn: Any) -> bool:
    try:
        ...
        return False
    return bool(parameters) and parameters[0].name == SESSION_PARAMETER


def wants_session(fn: Any) -> bool:
    """True se la callable attende la sessione runtime; il calcolo viene cachato."""
