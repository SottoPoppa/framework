...
session:session_data := test.session;

tuple:test_suite := (
    {
        "action": exports.get_view;
        "inputs": {"args": [session_data, "src/application/controller/kanban.dsl"]};
        "outputs": none;
    ...
    },
    {
        ...
        "inputs": {"args": [session_data]; "kwargs": {"widget": "missing"; "field": "value"}};
        "outputs": none;
    ...
    },
    {
        ...
        "inputs": {"args": [session_data]; "kwargs": {"selector": "#target"}};
        "outputs": "#target";
        "assert": @received.is_success == true & @received.output.value == @expected;
    ...
    },
    {
        ...
        "inputs": {"args": [session_data, "target", {}]};
    ...
    },
    {
        ...
        "inputs": {"args": [session_data]; "kwargs": {"url": "/integration"}};
