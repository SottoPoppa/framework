...
tuple:test_suite := (
    {
        ...
        "assert": @received.is_success == true & @received.output.value.provider == @expected.provider;
    ...
    },
    {
        ...
        "assert": @received.is_success == true & @received.output.value.networks != none;
    ...
    },
    {
        ...
        "inputs": {"args": [session]};
        "outputs": none;
        "assert": @received.is_success == true & @received.output.value.stub != none;
