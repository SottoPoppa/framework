...
tuple:test_suite := (
    {
        ...
        "outputs": none;
        "assert": @received.is_success == true & @received.output.value.user.email == "stub@example.test";
    ...
    },
    {
        ...
        "inputs": {"email": "stub@example.test"; "password": "secret"};
        "outputs": none;
        "assert": @received.is_success == true & @received.output.value.user.email == "stub@example.test" & @received.output.value.providers.stub.tokens.access_token == "access-stub-example-test";
